...
This is the network module for the link:https://github.com/oracle-devrel/terraform-oci-ocloud-configuration/[ocloud framework]. The code provisions the network topology for a service resident. 
